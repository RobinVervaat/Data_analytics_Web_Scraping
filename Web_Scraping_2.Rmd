...
#DTM matrix
DTM <- dfm(TOKS)
DTM <- dfm_select(DTM, min_nchar = 2, selection="remove", pattern=c("percent","chairman","fomc","board","feder","committe","market","econom","polici"), valuetype="fixed")
...
textplot_wordcloud(DTM, min_count = 40, random_order = FALSE, rotation = 0.25, color = RColorBrewer::brewer.pal(8, "Dark2"), max_size=5, min_size = 0.1)
```
